...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p Es el sistema o el método que se utiliza para realizar el traslado de la mercancía. Puede ser marítimo, aéreo, terrestre o ferroviario.
    ...
    ImagenInfograficaB.color-acento-contenido.mb-5
      ...
      div(x='33.75%', y='39.6%', tooltip='Aéreo')
        .row.justify-content-around.align-items-center.align-self-center.fnd-b
          .col-md-8 
            h3 Aéreo
            P Es el medio más ágil y rápido para el desarrollo de operaciones logísticas en el comercio internacional.
            h5 Ventajas:
            ul.lista-ul
              li
                | Entrega de las mercancías justo en el momento que se necesitan.
              li
                | Tasa de siniestralidad muy baja.
              li
                | Idóneo para tránsitos de mercancía de alto valor, documentos, muestras, piezas, mercancías urgentes, perecederos.
              li
          ...
          .col-md-4
            figure
              img(src='@/assets/tema3/img-4.svg')

      div(x='66.6%', y='38.1%', tooltip='Terrestre')
        .row.justify-content-around.align-items-center.align-self-center.fnd-b
          .col-md-8 
            h3 Terrestre
            p Es el modo más utilizado para el transporte de mercancía y el más asequible para todo tipo de empresas.
            h5 Ventajas:
            ul.lista-ul
              li
                | Ofrece entregas rápidas y confiables.
              li
                | Es más flexible, ya que permite la entrega de la mercancía puerta a puerta.
              li
                | Versátil.
            h5 Desventajas:
            ul.lista-ul
              li
                | Guerra en tarifas y fletes.
              li
      ...
      div(x='35%', y='69%', tooltip='Ferroviario')
        .row.justify-content-around.align-items-center.align-self-center.fnd-b
          .col-md-8 
            h3 Ferroviario
            p Es el transporte de mercancía sobre una vía férrea.
            h5 Ventajas:
            ul.lista-ul
              li
                | Capacidad para transportar grandes cantidades.
              li
                | Recorrido de largas distancias.
              li
                | Menor contaminación.
              li
                | Ofrece diferentes tipos de vehículos, de acuerdo con las características de la carga.

            h5 Desventajas:
            ul.lista-ul
              li
                | No tiene acceso a todas las rutas.
              li
                | Es inadecuado y muy costoso para recorridos cortos.
              li
                | Baja velocidad.
          .col-md-4
            figure
      ...
      div(x='67.8%', y='67.5%', tooltip='Marítimo')
        .row.justify-content-around.align-items-center.align-self-center.fnd-b
          .col-md-8 
            h3 Marítimo
            p Es utilizado para el transporte de mercancía de grandes volúmenes, para recorrer largas distancias y a unos costos bajos.
            h5 Ventajas:
            ul.lista-ul
              li
                | El volumen y la capacidad de almacenaje de los buques.
              li 
                | Los fletes marítimos son muy competitivos y económicos.
              li 
                | Las condiciones climatológicas no impiden su flujo, gracias a la robustez, resistencia y fiabilidad de los buques, ya que estos pueden desenvolverse con gran facilidad en ambientes complejos o inestables.
              li 
                | Es un modo de transporte que permite el traslado de carga líquida o peligrosa.
              li 
            ...
            ul.lista-ul
              li
                | La tramitología es extensa y complicada, por el número de permisos y formularios que deben tramitarse para su utilización.
              li 
                | El tiempo es uno de los puntos más débiles, puesto que este es lento y más elevado que el transporte aéreo/terrestre.
          .col-md-4
            figure
              img(src='@/assets/tema3/img-3.svg')
    ...
    TabsB.color-acento-contenido.mb-5
      .py-5(titulo='Buques', :icono='require("@/assets/tema3/img-7.svg")')
        .row.justify-content-center
          .col-lg-10
            .p-3(
              style='background-color: #5b46a9; border-top-left-radius: 30px; border-top-right-radius: 30px'
            )
              h4.mb-0.text-white.text-center Buques

        .row.px-5.px-lg-4.pt-5.justify-content-center(
          style='background-color: #f6f6f6; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px'
        )
          .col-lg-10
            .row.justify-content-center
      ...
      .py-4.py-md-5(
        ...
        .row.justify-content-center
          .col-lg-10
            .p-3(
              style='background-color: #4aa9c5; border-top-left-radius: 30px; border-top-right-radius: 30px'
            )
              h4.mb-0.text-center Aviones

        .row.px-5.px-lg-4.pt-5.justify-content-center(
          style='background-color: #4aa9c53d; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px'
        )
          .col-lg-10
            .row.justify-content-center.mb-5
              p.mb-5.text-center Se pueden encontrar diferentes tipos de aviones, de acuerdo con el uso que se les vaya a dar:
              ...
              .col-sm-6.col-lg-4.mb-4.mb-xl-0
                .tarjeta.tarjeta-flip.color-primario(
                  ...
                  .tarjeta-flip__contenedor
                    .tarjeta-flip__img(
                      :style='{ "background-image": `url(${require("@/assets/tema3/flip1.png")})` }'
                    )
            ...
            .row.justify-content-center.mb-5(
              ...
              ul.lista-ul.pt-4.mb-0
                li.mb-0
                  i.fas.fa-circle(style='font-size: 14px; color: #fd8f25')
                  h3.mb-0 Aviones de carga y pasajeros
              .col-lg-12.p-5.pt-4.pb-3
                p.mb-5 Dentro del transporte aéreo, se cuenta con los aviones mixtos, aquellos que transportan carga y pasajeros. Las personas se encuentran en la cabina y las mercancías en las bodegas. Lo más usados son: Airbus 319: Es un avión mixto, es decir, entre pasajeros y carga, esta última va en su bodega, la diferencia de este es que solo es para carga suelta.

                SlyderE(indicadores='centro')
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h3 Airbus 319
                      p.mb-0 Es un avión mixto, es decir, entre pasajeros y carga, esta última va en su bodega, la diferencia de este es que solo es para carga suelta.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img20.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h3 Airbus 320 y 321
                      p.mb-0 Tienen capacidad para cargar una línea de pallets al igual que una aeronave mayor, pero con una altura más reducida. El Airbus a320 tiene capacidad para 4 pallets y carga suelta, con un volumen de 19 m3 y una capacidad de 1.5 toneladas.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img21.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h3 Airbus 330
                      p.mb-0 Tienen una capacidad para 5 pallets y carga suelta, con un volumen de 64.5 m3 y una capacidad: 10.3 toneladas.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img22.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h3 Airbus 440
                      p.mb-0 Es un avión mixto, es decir, transporta pasajeros y transporta carga, la cual va en su bodega. Posee amplias zonas para el cargue de pallets, un área trasera de carga a granel, y está equipado con amplias puertas de carga en su parte delantera y posterior, para carga de pallets o contenedores de 88″ X 125″ o 96″ X 125″.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img23.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h3 Boeing 737
                      p.mb-0 Posee dos bahías centrales de carga, es solo para el transporte de carga suelta y tiene una capacidad de 2 toneladas.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img24.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h3 Boeing 777 – 200
                      p.mb-0 Posee zonas de carga adelante y atrás, el área para la carga suelta se encuentra en la parte trasera de la aeronave, con una capacidad para 6 pallets y carga suelta, con un volumen de 80 m3 y una capacidad de 18 toneladas.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img25.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h3 Boeing 747
                      p.mb-0 Es un avión mixto, es decir, entre pasajeros y carga, posee zonas de carga para pallets en sus partes delanteras y posteriores. Está dotado con amplias puertas para cargar pallets o contenedores de 88″ o 96″ x 125″, con una capacidad para 6 pallets y carga suelta y hasta 13 toneladas.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img26.png',
                          alt='imagen ambiental'
                        )
            ...
            .row.justify-content-center.mb-5(
              ...
              ul.lista-ul.pt-4.mb-0
                li.mb-0
                  i.fas.fa-circle(style='font-size: 14px; color: #fd8f25')
                  h3.mb-0 Aviones de carga
              .col-lg-12.p-5.pt-4.pb-3
                p.mb-5 Los aviones de carga o cargueros son aquellos destinados al transporte de mercancías de todo tipo de forma aérea. Entre los más comunes se encuentran:

                SlyderE(indicadores='centro')
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Boeing 747 – 400 ERF
                      p.mb-0 Posee mayor capacidad, particularmente con los pallets adicionales en la cubierta principal. También permite la posibilidad de que algunos clientes acompañen su carga, pues cuenta con seis asientos. Con una capacidad para 39 pallets y carga suelta, con un volumen de 674 m3 Está equipado con una puerta lateral o en su nariz (dependiendo del modelo), y puede cargar 29 pallets o contenedores en la cubierta principal, nueve pallets en las inferiores y carga suelta a granel. Con una capacidad para 38 pallets, con un volumen de 669 m3 y una capacidad de 107 toneladas.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img27.png',
                          alt='imagen ambiental'
                        )

                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Boeing 747 F – FREIGHTER
                      p.mb-0 Está equipado con una puerta lateral o en su nariz (dependiendo del modelo), y puede cargar 29 pallets o contenedores en la cubierta principal, nueve pallets en las inferiores y carga suelta a granel. Con una capacidad para 38 pallets, con un volumen de 669 m3 y una capacidad de 107 toneladas.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img28.png',
                          alt='imagen ambiental'
                        )
      ...
      .py-4.py-md-5(
        ...
        .row.justify-content-center
          .col-lg-10
            .p-3(
              style='background-color: #fd8f25; border-top-left-radius: 30px; border-top-right-radius: 30px'
            )
              h3.mb-0.text-center Camiones
        ...
        .row.px-5.px-lg-4.pt-5.justify-content-center(
          ...
          .col-lg-10
            .row.justify-content-center
              p.mb-5 De acuerdo con las características de la carga, como naturaleza, peso, volumen, entre otros, existen diferentes tipos de camiones:
              .col-lg-12.pb-3
                SlyderE(indicadores='centro')
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Camión
                      p.mb-0 Vehículo utilizado para el transporte de carga mediana, gracias a su gran tamaño, capacidad y fuerza.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img29.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Tracto camión
                      p.mb-0 Vehículos utilizados para el transporte de contenedores y de grandes cantidades de carga, por lo que están destinados a soportar y arrastrar tráiler, semirremolques y remolques.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img30.png',
                          alt='imagen ambiental'
                        )

                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Remolque articulado
                      p.mb-0 Vehículos que están formados por al menos dos estructuras rígidas, unidas por un punto de articulación.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img31.png',
                          alt='imagen ambiental'
                        )

                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Camión refrigerado:
                      p.mb-0 Vehículo especializado para el transporte de mercancía perecedera y diseñado con un dispositivo especial para regular y controlar la temperatura interior.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img32.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Camión cisterna
                      p.mb-0 Vehículo especializado para el transporte de líquidos, gases y químicos.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img33.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Camión tolva
                      p.mb-0 Diseñado con un cajón especial que puede levantarse a través de un sistema hidráulico para volcar su contenido. Utilizado para el transporte de productos granulados o pulverizados.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img34.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Camión cama baja
                      p.mb-0 Diseñado con una plataforma que permite el transporte de maquinaria o equipos pesados, como excavadoras, maquinaria especial, entre otros.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img35.png',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Camión jaula
                      p.mb-0 Vehículo diseñado para el transporte de ganado, con una jaula metálica.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img36.png',
                          alt='imagen ambiental'
                        )

                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Camión porta vehículos o niñera:
                      p.mb-0 Diseñado con una plataforma para transportar automóviles, de una manera ágil y rápida, gracias a su mecanismo de cargue y descargue.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img37.png',
                          alt='imagen ambiental'
                        )
      ...
      .py-4.py-md-5(
        ...
        .row.justify-content-center
          .col-lg-10
            .p-3(
              style='background-color: #35e9d0; border-top-left-radius: 30px; border-top-right-radius: 30px'
            )
              h3.mb-0.text-center Ferrocarril

        .row.px-5.px-lg-4.pt-5.pb-3.justify-content-center(
          style='background-color: #f6f6f6; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px'
        )
          .col-lg-10
            .row.justify-content-center
              p.mb-5 De acuerdo con las características de la carga, existen diferentes tipos de vagones:

              .col-lg-12
                SlyderE(indicadores='centro')
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Cerrado multiusos
                      p.mb-0 Utilizado para el transporte de carga seca.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img-38.svg',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Góndola
                      p.mb-0 Utilizado para el transporte de carga a granel.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img-39.svg',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Tolva
                      p.mb-0 Utilizado para el transporte de productos como carbón, arena, piedra, entre otros.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img-40.svg',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Tanque
                      p.mb-0 Utilizado para el transporte de gases, químicos y líquidos.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img-41.svg',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Multipropósito
                      p.mb-0 Utilizado para el transporte de madera, hierro, acero, entre otros.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img-42.svg',
                          alt='imagen ambiental'
                        )
                  ...
                  .row
                    .col-md-6.mb-4.mb-md-0
                      h4 Plataforma
                      p.mb-0 Utilizado para el transporte de contenedores.

                    .col-md-6
                      figure
                        img(
                          src='@/assets/tema3/img-43.svg',
                          alt='imagen ambiental'
                        )
    ...
    p.mb-5 Es el precio o los costos inherentes al transporte, es decir, lo que se debe pagar por el traslado de una mercancía, desde su lugar de origen hasta su lugar de destino, en el medio de transporte seleccionado, y este se calcula de acuerdo con el peso o volumen de la carga, encontrando:
    ...
    .row.justify-content-center
      .col-lg-10
        ...
        .row.justify-content-center.p-4.pb-0(
          ...
          p.mb-5 Es el costo que debe pagarse por el transporte de mercancía de un puerto a otro. Esta tarifa se establece de acuerdo con el peso, volumen de la carga o unidad (contenedor) de transporte utilizada. Se componen de:

          .row.mb-5
            TabsA.color-acento-contenido
              .tarjeta.color-primario.p-4(
                titulo='Tarifa básica',
                style='background-color: #ffff; border-radius: 0'
              )
                p Es el pago que se realiza directamente al transportador, o por medio de un agente, por el transporte y llegada de las mercancías en óptimas condiciones a su destino. Estos valores dependen de factores como: el tipo de mercancía, los costos de operación tanto del buque como los portuarios, la ruta seleccionada y la oferta y demanda de estos.

              .tarjeta.color-primario.p-4(
                titulo='Recargos',
                style='background-color: #ffff; border-radius: 0'
              )
                p Son aquellos costos adicionales que están determinados por situaciones puntuales que pueden afectar los costos del transportador, ya que no los puede controlar directamente, y que finalmente se suman a la tarifa básica. Dichos costos son:
                ul.lista-ul
                  li 
                    i.fas.fa-circle(style='font-size: 9px; color: #fd8d25')
                    p.mb-0 Fluctuaciones en el precio del combustible (BAF).
                  li 
                    i.fas.fa-circle(style='font-size: 9px; color: #fd8d25')
                    p.mb-0 Ajustes por tipo de cambio (CAF).
                  li 
                    i.fas.fa-circle(style='font-size: 9px; color: #fd8d25')
                    p.mb-0 Recargo por demoras congestión) en los puertos (CS).
                  li 
                    i.fas.fa-circle(style='font-size: 9px; color: #fd8d25')
                    p.mb-0 Seguridad en los puertos (CSF).
                  li 
                    i.fas.fa-circle(style='font-size: 9px; color: #fd8d25')
                    p.mb-0 Manejo portuario (THC).

              .tarjeta.color-primario.p-4(
                titulo='Descuentos',
                style='background-color: #ffff; border-radius: 0'
              )
                p Son los descuentos que se realizan teniendo en cuenta la fidelidad de los clientes, los volúmenes transportados y su frecuencia, por operaciones especiales, entre otros, y que se calculan sobre la tarifa básica.

          .row.justify-content-center.mb-5
            h3 Tipos de contratación
            p.mb-5 De acuerdo con el servicio contratado, es posible encontrar:
            .col-lg-11
          ...
          .row.mb-5
            h3 Tipos de flete
            p.mb-5 Dependiendo de la operación incluida dentro del proceso de transporte de la mercancía, es posible encontrar diferentes tipos de fletes o tarifas:
        ...
        .row.justify-content-center(
          style='background-color: #f3f9ff; margin-bottom: 60px'
        )
          .col-lg-11
            .row.justify-content-center
              .col-lg-12
                h3 Liquidación
                p El flete consiste en una tarifa básica y diferentes tipos de recargos que se aplican por tráfico y para todas las mercancías movilizadas. Así pues, la tarifa básica es el costo del transporte de un producto determinado entre dos puntos o lugares específicos; y los recargos son los elementos que se suman a dicha tarifa con la finalidad de poder compensar las variaciones en los costos y/o condiciones de la operación.

            .row.justify-content-center.fondo-i
              .col-lg-12.px-md-5
                .row
                  .col-lg-8.align-self-center.fnd-bl
                    p Para la liquidación de los fletes marítimos, se toma el factor que más favorezca, ya sea por el peso (tonelada) o por el volumen (m3-p3) de cada embarque; y dicha relación también es conocida como "factor de estiba", el cual varía según la densidad y peso específico de cada producto. Por esto, es importante que el exportador siempre conozca cuál es la relación de su mercancía, para conocer por qué factor se le realizará la liquidación; y esta relación se puede calcular así:
                    figure
                      img.img-c.img-190(src='@/assets/tema3/frml.svg') 
        ...
        .row.mb-0 
          ...
          .row.fnd-1a
            .col-md-8.p-5
              ...
              ul.lista-ul
                li
                  | Dependiendo del peso y características de la carga, es posible encontrar diferentes tipos de fletes o tarifas:
          ...
          .row.justify-content-around.align-items-center.fnd-1
            ...
            .row.justify-content-around.align-items-center
              .row.fnd-gris.mb-5.justify-content-around.align-items-center
                .col-lg-8.align-self-center
                  p El exportador podrá aproximar la cantidad de kilos a la escala de la tarifa inmediatamente superior si con esto ve que el flete total es más bajo. Para calcular y conocer los kilos de volumen, se tiene la siguiente fórmula:
                  figure
                    img.img-c.img-190(src='@/assets/tema3/forml2.svg') 
    ...
    separador
    #t_3_3.titulo-segundo
      h2 3.4 Consolidación y desconsolidación (FCL, LCL)

    p.mb-5 Permite lograr la optimización del espacio del contenedor, así como facilitar la manipulación y circulación de la mercancía dentro de este. Generalmente, es utilizada por las pequeñas y medianas empresas, por el bajo volumen que manejan. Se consolida la carga, que consiste en la agrupación de varias cargas de diferentes empresas, en una misma unidad de transporte, a menores costos; y la desconsolidación, que consiste en desagrupar aquella carga consolidada.
    ...
    .row.justify-content-around.align-items-center.fnd-1.mb-5
      .col-lg-10
        .row.mb-5
          .col-md-6.col-lg.mb-5.mb-lg-0
            .tarjeta-avatar
              img(src='@/assets/tema3/img-56.svg', alt='AvatarTop')
              .tarjeta.t2.color-primario--borde
                .p-4
                  h2.text-center Marítimo
                  ul.lista-ul
                    li 
                    ...
                    li 
                      i.fas.fa-angle-right.tt1
                      | Hundimientos, varada o colisión
                    li 
                      i.fas.fa-angle-right.tt1
                      | Pérdidas de bultos.
                    li 
          ...
          .col-md-6.col-lg.mb-5.mb-lg-0
            .tarjeta-avatar
              img(src='@/assets/tema3/img-57.svg', alt='AvatarTop')
              .tarjeta.color-primario--borde.t2
                .p-4
                  h2.text-center Aéreo
                  ul.lista-ul
                    li 
                      i.fas.fa-angle-right.tt1
          ...
          .col-md-6.col-lg.mb-5.mb-lg-0
            .tarjeta-avatar
              img(src='@/assets/tema3/img-58.svg', alt='AvatarTop')
              .tarjeta.color-primario--borde.t2
                .p-4
                  h2.text-center Terrestre
                  ul.lista-ul
                    li 
                      i.fas.fa-angle-right.tt1
                      | Accidentes.
      ...
      .col-lg-10
        .row.mb-0 
          .row.justify-content-center
            .col-lg-10
              .row.mb-0.fnd-3a
                h3.text-white.text-center.pt-2 Seguros

    .row.mb-5.justify-content-center.fnd-1 
      .col-lg-10
        .row
          p.mb-4 En los seguros, las pólizas ofrecen una cobertura completa, que comprende:
          ...
          TabsA.color-secundario.mb-5
            ...
            .tarjeta.color-acento-botones--borde.p-4(
              ...
              h4 Falta de entrega
              p Cubre la desaparición por extravío, hurto o hurto calificado de uno o más bultos completos (empaque y contenido) en que se halle dividido el despacho.

            .tarjeta.color-acento-botones--borde.p-4(
              titulo='Avería particular',
              style='border: 0; border-radius: 0'
            )
              h4 Avería particular
              p Cubre los daños físicos que sufran las mercancías durante el trayecto asegurado, tales como roturas, abolladuras, derrame de líquidos, contaminación y similares. Es conveniente tener en cuenta que cuando los daños son como consecuencia de un accidente del vehículo transportador, estos están cubiertos bajo el amparo básico.
            ...
            .tarjeta.color-acento-botones--borde.p-4(
              ...
              h4 Saqueo
              p Este amparo cubre las sustracciones parciales o totales del contenido que se encuentre en una o varias de las unidades de empaque que configuran el despacho. La diferencia entre los amparos de falta de entrega y saqueo consiste en que el primero hace relación tanto al empaque como al contenido.
              p Los siguientes bienes no podrán asegurarse en la póliza de mercancías, ya que son objeto de la póliza de transporte de valores:
              ol.lista-ol--cuadro
                li 
                ...
                li 
                  .lista-ol--cuadro__vineta
                    span 2
                  | Metales y piedras preciosas, objetos y joyas de piedras preciosas.
                li 
                  .lista-ol--cuadro__vineta
                    span 3
    ...
    #t_3_6.titulo-segundo
      h2 3.6 Documentos de transporte
    p.mb-5 De acuerdo con el medio de transporte, existe un documento o contrato de transporte, que es un acuerdo entre las partes para disponer la mercancía a cargo de un transportista para su traslado desde el lugar de origen hasta el destino, y estos son emitidos por las compañías de transporte. Representan:
...
export default {
  ...
  data: () => ({
    datosSlyder4: [
      {
        titulo: 'Cerrado multiusos: ',
        texto: 'Utilizado para el transporte de carga seca.',
        imagen: require('@/assets/tema3/img-38.svg'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Góndola:',
        texto: 'Utilizado para el transporte de carga a granel.',
        imagen: require('@/assets/tema3/img-39.svg'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Tolva:',
        texto:
          'Utilizado para el transporte de productos como carbón, arena, piedra, entre otros.',
        imagen: require('@/assets/tema3/img-40.svg'),
        leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Tanque:',
        texto: 'Utilizado para el transporte de gases, químicos y líquidos.',
        imagen: require('@/assets/tema3/img-41.svg'),
        leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Multipropósito:',
        texto:
          'Utilizado para el transporte de madera, hierro, acero, entre otros.',
        imagen: require('@/assets/tema3/img-42.svg'),
        leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Plataforma:',
        texto: 'Utilizado para el transporte de contenedores.',
        imagen: require('@/assets/tema3/img-43.svg'),
        leyendaImagen: 'Leyenda de la imagen',
      },
    ],
  }),
